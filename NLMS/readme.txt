This folder has all the programs necessary for implementing the Normalized Least Mean Square filter.
...
main code to be run - runNLMSFull.m

parameters for NLMS code is set using - setNLMSStruct.m
...
function for NLMS implementation - doNLMS.m (main program to be modified to change the algorithm)
