This folder has all the programs necessary for implementing the Static Wiener filter.
...
main code to be run - testWienerStatic.m
...
function for Wiener implementation - evalWiener, wienerMISO.m (main program to be modified to change the algorithm)

wienerMISO.m estimates the dynamic Wiener filter and a comparuson between static and dynamic Wiener filter
is implemented.
...
WFiltJuly31.mat is the static Wiener filter estimated using the data from July 31, 2023.
